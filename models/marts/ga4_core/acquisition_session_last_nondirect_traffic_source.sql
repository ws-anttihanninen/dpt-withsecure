...
with
    ...
    prep as (
        ...
        group by
            event_date_dt, country, user_pseudo_id, session_id, unique_session_id, landing_page
    )
...
group by event_date_dt, country, source, medium, campaign, user, unique_session
